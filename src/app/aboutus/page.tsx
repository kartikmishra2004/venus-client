...
const AboutUs = () => {
    return (
        <section className="bg-zinc-900 mt-24 text-white px-6 py-12 mb-10 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-10 mb-16">
                <div className="md:w-1/2">
                    ...
                    <div className="flex items-start gap-6">
                        <Image width={96} height={100} src="/15.webp" alt="Players Playing Indoor Sports" className="w-24 rounded-lg shadow" />
            ...
            <div className="bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 rounded-lg p-8 text-center">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-10 max-w-4xl mx-auto">
                    <div className="bg-zinc-800 rounded-md px-6 py-5 text-left flex-1">
