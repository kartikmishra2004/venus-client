...
const SidebarMobileOpenButton: React.FC<SidebarMobileOpenButtonProps> = ({
    ...
    return (
        <button
            ...
            className={cn(
                "fixed top-20 left-0 z-50 rounded-r-lg flex h-10 w-6 items-center justify-center border bg-sidebar text-sidebar-foreground bg-zinc-800 shadow-lg md:hidden",
                className
            )}
